...
Guid(GuidList.guidVsGuidPkgString)> _
Public NotInheritable Class VsGuidPackage
    Inherits Package
...
#Region "Package Members"
    ...
    Protected Overrides Sub Initialize()
        ...
        If Not mcs Is Nothing Then
            ...
            Dim menuCommandID As New CommandID(GuidList.guidVsGuidCmdSet, CInt(PkgCmdIDList.cmdInsertGuid))
    ...
    Private Sub MenuItemCallback(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If dte.ActiveDocument IsNot Nothing Then
                ' These are the only real two lines of coding here that insert the guid.  Hmm, tada!
                Dim sel As TextSelection = DirectCast(dte.ActiveDocument.Selection, EnvDTE.TextSelection)
                sel.Insert(Guid.NewGuid.ToString)
            End If
